...
local awesome_overrides =
  ...
  theme.font = 'Cantarell Regular 10'
  theme.title_font = 'Cantarell Regular 13'
    ...
    dpi(24) ..
      ':0,' ..
        theme.primary.hue_900 ..
          ':0.85,' .. theme.primary.hue_900 .. ':0.85,' .. theme.primary.hue_500 .. ':1,' .. theme.primary.hue_500

  -- Tasklist

  theme.tasklist_font = 'Cantarell Regular 10'
